    ...
    <div class="container-custom py-4">
      <div class="flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center space-x-2">
          ...
          <NuxtLink to="/leaderboard" class="navbar-link">Leaderboard</NuxtLink>
          <template v-if="!user">
            <NuxtLink to="/auth/login" class="btn-outline ml-4">Login</NuxtLink>
            <NuxtLink to="/auth/register" class="btn-primary ml-2">Sign Up</NuxtLink>
          </template>
          <template v-else>
